...
import org.firstinspires.ftc.teamcode.drive.roadrunner.DriveConstants;
import org.firstinspires.ftc.teamcode.drive.roadrunner.SampleMecanumDrive;
import org.firstinspires.ftc.teamcode.drive.opmode.ArmControl;
            ...
            if (tagOfInterest.id==11){
                ...
                TrajectorySequence Park3 = drive.trajectorySequenceBuilder(temp)
                        ...
                        .forward(2.5,
                                SampleMecanumDrive.getVelocityConstraint(40,DriveConstants.MAX_ANG_VEL,DriveConstants.TRACK_WIDTH),
                                SampleMecanumDrive.getAccelerationConstraint(30))
                        .splineToSplineHeading(new Pose2d(temp.getX()-(6*(1/Math.sqrt(2))), temp.getY()-(6*(1/Math.sqrt(2))), Math.toRadians(0)), Math.toRadians(-45),
                                SampleMecanumDrive.getVelocityConstraint(40,DriveConstants.MAX_ANG_VEL,DriveConstants.TRACK_WIDTH),
                                SampleMecanumDrive.getAccelerationConstraint(30))
                        .splineToConstantHeading(new Vector2d(24, stackPos.getY()), Math.toRadians(180),
                                SampleMecanumDrive.getVelocityConstraint(40,DriveConstants.MAX_ANG_VEL,DriveConstants.TRACK_WIDTH),
                                SampleMecanumDrive.getAccelerationConstraint(30))
                        .splineToConstantHeading(new Vector2d(12, stackPos.getY()), Math.toRadians(180),
