...
public class DriveConstants {
    ...
    public static final double MAX_RPM = 489;
     ...
     * empirically tuned.
     */
    public static double kV = 1; //changed from .0115 -xavier
    public static double kA = 0; // changed from 0.002 -xavier
    public static double kStatic = 0; //changed from .068 -xavier
    ...
    public static double MAX_ANG_VEL = Math.toRadians(180); // Math.toRadians(200); //6.5; changed from 6.5 -Xavier
